...
import { PlayIcon, RedoIcon, UndoIcon } from '@/components/icons'
...
import { PublishButtonOriginal } from '@/features/publish/components/PublishButtonOriginal'
import { PublishButtonAlterado } from '@/features/publish/components/PublishButtonAlterado'
  ...
  return (
    ...
    >
      ...
      >
        <HStack alignItems="center" spacing={3}>
          ...
          <HStack spacing={1}>
            ...
            {!process.env.NEXT_PUBLIC_MILVUS_PRODUCTION && (
              <EditableTypebotName
          ...
          <Button
            onClick={() => {
              alert('O Typebot Milvus é uma versao BETA!')
            }}
            size="sm"
            colorScheme={'orange'}
          >
      ...
      <HStack right="40px" pos="absolute" display={['none', 'flex']}>
        ...
        {process.env.NEXT_PUBLIC_MILVUS_PRODUCTION && <PublishButtonAlterado />}
        {!process.env.NEXT_PUBLIC_MILVUS_PRODUCTION && (
          <PublishButtonOriginal size="sm" />
        )}
      </HStack>
    </Flex>
  )
